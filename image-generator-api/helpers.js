...
export function generateImagePromt(style, card, summary) {
    ...
    const contentBit = "The actual scene you must depict is of people playing a game, SPECIFICALLY DOING THE FOLLOWING: \n" + card.title + ": " + card.content + "\n";
    const contextBit = "Whilst loosley keeping in mind the overall goal of the game: \n" + summary;
        ...
        try {
            getImageBuffer(promt).then((imageBuffer) => {
                ...
                .then(resizedImageBuffer => {
                    ...
                    uploadBlob(resizedImageBuffer, path, filename)
                    .then((snapshot) => {
